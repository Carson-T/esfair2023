...
def args_parser():
    ...
    parser.add_argument('--loss_func', default="FocalLoss")
    parser.add_argument('--init', default="xavier")
    parser.add_argument('--lr_scheduler', default="Warm-up-Cosine-Annealing")
    parser.add_argument('--model_name',  default="resnet50-fp16-server-v4")
    ...
    parser.add_argument('--log_dir', default="./log/resnet50/resnet50-fp16-server-v4")
