...
def args_parser():
    ...
    parser.add_argument('--model_name',  default="convnextv2_n-fp16-server-mixed-v4")
    parser.add_argument('--train_csv_path', default="../preprocessed_data/fold3_train.csv")
    parser.add_argument('--val_csv_path',  default="../preprocessed_data/fold3_val.csv")
