...
def args_parser():
    ...
    parser.add_argument('--backbone', default="efficientnetv2_rw_s.ra2_in1k")
    parser.add_argument('--model_name',  default="effnetv2_s-fp16-server-mixed-v4")
    ...
    parser.add_argument('--log_dir', default="./log/efficientNet/effnetv2_s-fp16-server-mixed-v4")
