...
def args_parser():
    ...
    parser.add_argument('--lr', type=list, default=[0.00005, 0.0001])
    ...
    parser.add_argument('--teacher_model', default="../saved_model/convnext/convnextv2_n-fp16-server-ext-v2.pth")
