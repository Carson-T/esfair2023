...
def args_parser():
    ...
    parser.add_argument('--lr', type=list, default=[0.00005, 0.0005])
    ...
    parser.add_argument('--backbone', default="mobilenetv3_large_100.ra_in1k")
    parser.add_argument('--model_name',  default="mobilenetv3_l-fp16-server-ext-v2")
