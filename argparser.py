...
def args_parser():
    ...
    parser.add_argument('--model_name',  default="resnest50-fp16-server-v1")
    ...
    parser.add_argument('--saved_path', default='../saved_model/resnest50')
    parser.add_argument('--spd_para', type=float, default=0.2)
    parser.add_argument('--log_dir', default="./log/resnest50/resnest50-fp16-server-v1")
