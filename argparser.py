...
def args_parser():
    ...
    parser.add_argument('--is_multiscale', type=int, default=1)
    ...
    parser.add_argument('--model_name',  default="resnet50-fp16-server-v6")
    ...
    parser.add_argument('--log_dir', default="./log/resnet50/resnet50-fp16-server-v6")
