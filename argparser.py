...
def args_parser():
    ...
    parser.add_argument('--lapha', type=float, default=0.3)
    ...
    parser.add_argument('--backbone', default="convnextv2_nano.fcmae_ft_in1k")  # convnextv2_nano.fcmae_ft_in1k  mobilenetv3_large_100.ra_in1k
    parser.add_argument('--model_name',  default="convnextv2_n-fp16-server-ext-v6")
