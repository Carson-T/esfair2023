...
def transform(args):
    train_transforms = albumentations.Compose([
        ...
        albumentations.CLAHE(clip_limit=4.0, p=0.5),
        ...
        albumentations.CoarseDropout(max_holes=1, max_height=int(args["resize"] * 0.2), max_width=int(args["resize"] * 0.2), min_height=1, min_width=1, p=0.5),
